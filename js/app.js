...
(() => {
  ...
  function pageBigscreen(){
    ...
    <div class="bigscreen bs-v8">
      ...
      <div class="bs-top">
        <div class="bs-brand">
          <img src="assets/logo.png?v=41" alt="YILATE">
              ...
              <div class="bs-dh bs-dh-center" id="dhBox" title="点击机器人听牧场简介">
                <div class="dh-avatar dh-human">
                  <div class="human-photo-wrap barga-wrap">
                    <img class="human-photo barga-base" src="assets/photos/digital4-base.png" alt="新真人数字人讲解员">
                    <img class="human-hand hand-a" src="assets/photos/digital4-hand-a.png" alt="">
                    <img class="human-hand hand-b" src="assets/photos/digital4-hand-b.png" alt="">
  ...
  function pageProfile() {
    ...
    <div class="page">
      <div class="ranch-hero">
        <div class="rh-inner">
          <div class="rh-logo"><img src="assets/logo.png?v=41" alt="YILATE Smart Ranch"></div>
